...
- `quantize before grid vote` is enabled by default. It limits the source colors before cell voting so tiny intended colors survive as palette colors instead of becoming blended averages.
